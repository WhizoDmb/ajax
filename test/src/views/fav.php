        ...
        <div class="col-sm-6 col-12 col-mc-3 col-lg-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button class="btn btn-primary del-to-favorites" data-imdb-id="<?php echo $item['imdb']; ?>" data-title="<?php echo $item['nombre']; ?>" data-year="<?php echo $item['ano']; ?>" data-type="<?php echo $item['tipo']; ?>" data-poster="<?php echo $item['imagen']; ?>" data-id_fav="<?php echo $item['id_fav']; ?>">
                Eliminar
              </button>
            </div>
          </div>
